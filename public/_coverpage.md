...
<div class="llm-dataset-section main-content">
  <div class="llm-dataset-title">LLM-LangChain（LangGraph）</div>
  <div class="llm-dataset-wall">
    <a class="llm-dataset-item" href="/#/llm_langchain/03_01_llm类模型简介.md" target="_blank">
      <img class="llm-dataset-icon" src="https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f4da.svg" alt="文档"/>
      <div class="llm-dataset-label">LLM类模型简介</div>
    </a>
    <a class="llm-dataset-item" href="/#/llm_langchain/04_llm技术详解与langchain实战.md" target="_blank">
      <img class="llm-dataset-icon" src="https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/2699.svg" alt="技术"/>
      <div class="llm-dataset-label">LLM技术详解与LangChain实战</div>
    </a>
    <a class="llm-dataset-item" href="/#/llm_langchain/05_openai_vs_chatopenai_demo.py" target="_blank">
      <img class="llm-dataset-icon" src="https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f4bb.svg" alt="代码"/>
      <div class="llm-dataset-label">OpenAI vs ChatOpenAI 演示代码</div>
    </a>
    <a class="llm-dataset-item" href="/#/llm_langchain/06_openai_vs_chatopenai_详细差异说明.md" target="_blank">
      <img class="llm-dataset-icon" src="https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f4dd.svg" alt="文档"/>
      <div class="llm-dataset-label">OpenAI vs ChatOpenAI 详细差异说明</div>
    </a>
    <a class="llm-dataset-item" href="/#/llm_langchain/07_token_multilingual_analysis.py" target="_blank">
      <img class="llm-dataset-icon" src="https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f4ca.svg" alt="分析"/>
      <div class="llm-dataset-label">Token多语言分析</div>
    </a>
    <a class="llm-dataset-item" href="/#/llm_langchain/08_token_cost_calculator.py" target="_blank">
      <img class="llm-dataset-icon" src="https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f4b0.svg" alt="计算"/>
      <div class="llm-dataset-label">Token成本计算器</div>
    </a>
    <a class="llm-dataset-item" href="/#/llm_langchain/09_token_visualization.py" target="_blank">
      <img class="llm-dataset-icon" src="https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f4c8.svg" alt="可视化"/>
      <div class="llm-dataset-label">Token可视化</div>
    </a>
    <a class="llm-dataset-item" href="/#/llm_langchain/10_advanced_token_management.md" target="_blank">
      <img class="llm-dataset-icon" src="https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f527.svg" alt="管理"/>
      <div class="llm-dataset-label">高级Token管理</div>
    </a>
    <a class="llm-dataset-item" href="/#/llm_langchain/11_memory_cache.py" target="_blank">
      <img class="llm-dataset-icon" src="https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f9e0.svg" alt="内存"/>
      <div class="llm-dataset-label">内存缓存实现</div>
    </a>
    <a class="llm-dataset-item" href="/#/llm_langchain/12_sqlite_cache.py" target="_blank">
      <img class="llm-dataset-icon" src="https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f4be.svg" alt="数据库"/>
      <div class="llm-dataset-label">SQLite缓存实现</div>
    </a>
    <a class="llm-dataset-item" href="/#/llm_langchain/13_mysql_cache.py" target="_blank">
      <img class="llm-dataset-icon" src="https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f4be.svg" alt="数据库"/>
      <div class="llm-dataset-label">MySQL缓存实现</div>
    </a>
    <a class="llm-dataset-item" href="/#/llm_langchain/14_redis_cache.py" target="_blank">
      <img class="llm-dataset-icon" src="https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f504.svg" alt="缓存"/>
      <div class="llm-dataset-label">Redis缓存实现</div>
    </a>
    <a class="llm-dataset-item" href="/#/llm_langchain/15_mongodb_cache.py" target="_blank">
      <img class="llm-dataset-icon" src="https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f4be.svg" alt="数据库"/>
      <div class="llm-dataset-label">MongoDB缓存实现</div>
    </a>
    <a class="llm-dataset-item" href="/#/llm_langchain/16_semantic_cache.py" target="_blank">
      <img class="llm-dataset-icon" src="https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f9e0.svg" alt="语义"/>
      <div class="llm-dataset-label">语义缓存实现</div>
    </a>
    <a class="llm-dataset-item" href="/#/llm_langchain/17_gptcache_integration.py" target="_blank">
      <img class="llm-dataset-icon" src="https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f4ca.svg" alt="集成"/>
      <div class="llm-dataset-label">GPTCache集成</div>
    </a>
    <a class="llm-dataset-item" href="/#/llm_langchain/18_unified_cache_manager.py" target="_blank">
      <img class="llm-dataset-icon" src="https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f4c5.svg" alt="统一"/>
      <div class="llm-dataset-label">统一缓存管理器</div>
    </a>
    <a class="llm-dataset-item" href="/#/llm_langchain/19_缓存技术全栈实施指南.md" target="_blank">
      <img class="llm-dataset-icon" src="https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f4da.svg" alt="指南"/>
      <div class="llm-dataset-label">缓存技术全栈实施指南</div>
    </a>
    <a class="llm-dataset-item" href="/#/llm_langchain/20_缓存技术全栈实施指南-2.md" target="_blank">
      <img class="llm-dataset-icon" src="https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f4da.svg" alt="指南"/>
      <div class="llm-dataset-label">缓存技术全栈实施指南-2</div>
    </a>
    <a class="llm-dataset-item" href="/#/llm_langchain/21_缓存技术全栈实施指南-3.md" target="_blank">
      <img class="llm-dataset-icon" src="https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f4da.svg" alt="指南"/>
      <div class="llm-dataset-label">缓存技术全栈实施指南-3</div>
    </a>
    <a class="llm-dataset-item" href="/#/llm_langchain/22_prompt生命周期.md" target="_blank">
      <img class="llm-dataset-icon" src="https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f4cb.svg" alt="生命周期"/>
      <div class="llm-dataset-label">Prompt生命周期</div>
    </a>
    <a class="llm-dataset-item" href="/#/llm_langchain/23_langchain_prompt模板技术文档.md" target="_blank">
      <img class="llm-dataset-icon" src="https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f4dd.svg" alt="模板"/>
      <div class="llm-dataset-label">LangChain Prompt模板技术文档</div>
    </a>
    <a class="llm-dataset-item" href="/#/llm_langchain/24_prompt_templates.py" target="_blank">
      <img class="llm-dataset-icon" src="https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f4bb.svg" alt="代码"/>
      <div class="llm-dataset-label">Prompt模板实现</div>
    </a>
    <a class="llm-dataset-item" href="/#/llm_langchain/25_prompt_examples.py" target="_blank">
      <img class="llm-dataset-icon" src="https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f4bb.svg" alt="代码"/>
      <div class="llm-dataset-label">Prompt示例代码</div>
    </a>
    <a class="llm-dataset-item" href="/#/llm_langchain/26_prompt_lifecycle_flow.md" target="_blank">
      <img class="llm-dataset-icon" src="https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f4c8.svg" alt="流程"/>
      <div class="llm-dataset-label">Prompt生命周期流程</div>
    </a>
    <a class="llm-dataset-item" href="/#/llm_langchain/27_partial_and_custom_templates.py" target="_blank">
      <img class="llm-dataset-icon" src="https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f4bb.svg" alt="代码"/>
      <div class="llm-dataset-label">部分和自定义模板</div>
    </a>
    <a class="llm-dataset-item" href="/#/llm_langchain/28_partial_custom_templates_guide.md" target="_blank">
      <img class="llm-dataset-icon" src="https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f4da.svg" alt="指南"/>
      <div class="llm-dataset-label">部分自定义模板指南</div>
    </a>
    <a class="llm-dataset-item" href="/#/llm_langchain/29_partial_templates_flow.md" target="_blank">
      <img class="llm-dataset-icon" src="https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f4c8.svg" alt="流程"/>
      <div class="llm-dataset-label">部分模板流程</div>
    </a>
    <a class="llm-dataset-item" href="/#/llm_langchain/30_partial_template_examples.py" target="_blank">
      <img class="llm-dataset-icon" src="https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f4bb.svg" alt="代码"/>
      <div class="llm-dataset-label">部分模板示例</div>
    </a>
    <a class="llm-dataset-item" href="/#/llm_langchain/31_test_partial_examples.py" target="_blank">
      <img class="llm-dataset-icon" src="https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f9ea.svg" alt="测试"/>
      <div class="llm-dataset-label">测试部分模板示例</div>
    </a>
    <a class="llm-dataset-item" href="/#/llm_langchain/32_partial_custom_templates_summary.md" target="_blank">
      <img class="llm-dataset-icon" src="https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f4ca.svg" alt="总结"/>
      <div class="llm-dataset-label">部分自定义模板总结</div>
    </a>
    <a class="llm-dataset-item" href="/#/llm_langchain/34_langchain_example_selector_guide.md" target="_blank">
      <img class="llm-dataset-icon" src="https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f4dd.svg" alt="指南"/>
      <div class="llm-dataset-label">LangChain示例选择器指南</div>
    </a>
    <a class="llm-dataset-item" href="/#/llm_langchain/35_example_selector_usage_guide.py" target="_blank">
      <img class="llm-dataset-icon" src="https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f4bb.svg" alt="代码"/>
      <div class="llm-dataset-label">示例选择器使用指南</div>
    </a>
    <a class="llm-dataset-item" href="/#/llm_langchain/36_example_selector_complete_guide.md" target="_blank">
      <img class="llm-dataset-icon" src="https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f4da.svg" alt="完整指南"/>
      <div class="llm-dataset-label">示例选择器完整指南</div>
    </a>
    <a class="llm-dataset-item" href="/#/llm_langchain/37_output_parsers_guide.md" target="_blank">
      <img class="llm-dataset-icon" src="https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f4dd.svg" alt="指南"/>
      <div class="llm-dataset-label">输出解析器指南</div>
    </a>
    <a class="llm-dataset-item" href="/#/llm_langchain/38_output_parsers_complete_guide.md" target="_blank">
      <img class="llm-dataset-icon" src="https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f4da.svg" alt="完整指南"/>
      <div class="llm-dataset-label">输出解析器完整指南</div>
    </a>
    <a class="llm-dataset-item" href="/#/llm_langchain/39_rag_vs_finetuning_comprehensive_guide.md" target="_blank">
      <img class="llm-dataset-icon" src="https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f4da.svg" alt="综合指南"/>
      <div class="llm-dataset-label">RAG vs 微调综合指南</div>
    </a>
    <a class="llm-dataset-item" href="/#/llm_langchain/40_example_selector_implementation.py" target="_blank">
      <img class="llm-dataset-icon" src="https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f4bb.svg" alt="实现"/>
      <div class="llm-dataset-label">示例选择器实现</div>
    </a>
    <a class="llm-dataset-item" href="/#/llm_langchain/41_example_selector_simple.py" target="_blank">
      <img class="llm-dataset-icon" src="https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f4bb.svg" alt="简单实现"/>
      <div class="llm-dataset-label">示例选择器简单实现</div>
    </a>
    <a class="llm-dataset-item" href="/#/llm_langchain/42_example_selector_usage_config.json" target="_blank">
      <img class="llm-dataset-icon" src="https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f4c3.svg" alt="配置"/>
      <div class="llm-dataset-label">示例选择器配置</div>
    </a>
    <a class="llm-dataset-item" href="/#/llm_langchain/43_project_summary.md" target="_blank">
      <img class="llm-dataset-icon" src="https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f4ca.svg" alt="总结"/>
      <div class="llm-dataset-label">项目总结</div>
    </a>
    <a class="llm-dataset-item" href="/#/llm_langchain/44_output_parsers_implementation.py" target="_blank">
      <img class="llm-dataset-icon" src="https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f4bb.svg" alt="实现"/>
      <div class="llm-dataset-label">输出解析器实现</div>
    </a>
    <a class="llm-dataset-item" href="/#/llm_langchain/45_output_parsers_simple.py" target="_blank">
      <img class="llm-dataset-icon" src="https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f4bb.svg" alt="简单实现"/>
      <div class="llm-dataset-label">输出解析器简单实现</div>
    </a>
    <a class="llm-dataset-item" href="/#/llm_langchain/46_simple_parsers_config.json" target="_blank">
      <img class="llm-dataset-icon" src="https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f4c3.svg" alt="配置"/>
      <div class="llm-dataset-label">简单解析器配置</div>
    </a>
    <a class="llm-dataset-item" href="/#/llm_langchain/47_output_parsers_usage.py" target="_blank">
      <img class="llm-dataset-icon" src="https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f4bb.svg" alt="使用"/>
      <div class="llm-dataset-label">输出解析器使用</div>
    </a>
    <a class="llm-dataset-item" href="/#/llm_langchain/48_output_parsers_final.py" target="_blank">
      <img class="llm-dataset-icon" src="https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f4bb.svg" alt="最终版本"/>
      <div class="llm-dataset-label">输出解析器最终版本</div>
    </a>
    <a class="llm-dataset-item" href="/#/llm_langchain/49_final_parsers_performance.json" target="_blank">
      <img class="llm-dataset-icon" src="https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f4ca.svg" alt="性能"/>
      <div class="llm-dataset-label">解析器性能数据</div>
    </a>
    <a class="llm-dataset-item" href="/#/llm_langchain/50_output_parsers_project_summary.md" target="_blank">
      <img class="llm-dataset-icon" src="https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f4ca.svg" alt="总结"/>
      <div class="llm-dataset-label">输出解析器项目总结</div>
    </a>
    <a class="llm-dataset-item" href="/#/llm_langchain/51_model_configuration_serialization.md" target="_blank">
      <img class="llm-dataset-icon" src="https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f4dd.svg" alt="配置"/>
      <div class="llm-dataset-label">模型配置序列化</div>
    </a>
    <a class="llm-dataset-item" href="/#/llm_langchain/52_openai_api_parameters_detailed.md" target="_blank">
      <img class="llm-dataset-icon" src="https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f4dd.svg" alt="API"/>
      <div class="llm-dataset-label">OpenAI API参数详解</div>
    </a>
    <a class="llm-dataset-item" href="/#/llm_langchain/53_rag_finetune_decision_tool.py" target="_blank">
      <img class="llm-dataset-icon" src="https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f4bb.svg" alt="工具"/>
      <div class="llm-dataset-label">RAG微调决策工具</div>
    </a>
    <a class="llm-dataset-item" href="/#/llm_langchain/54_rag_finetune_simple_tool.py" target="_blank">
      <img class="llm-dataset-icon" src="https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f4bb.svg" alt="工具"/>
      <div class="llm-dataset-label">RAG微调简单工具</div>
    </a>
    <a class="llm-dataset-item" href="/#/llm_langchain/55_rag_finetune_decision_results.json" target="_blank">
      <img class="llm-dataset-icon" src="https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f4ca.svg" alt="结果"/>
      <div class="llm-dataset-label">RAG微调决策结果</div>
    </a>
    <a class="llm-dataset-item" href="/#/llm_langchain/56_rag_vs_finetuning_final_guide.md" target="_blank">
      <img class="llm-dataset-icon" src="https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f4da.svg" alt="最终指南"/>
      <div class="llm-dataset-label">RAG vs 微调最终指南</div>
    </a>
    <a class="llm-dataset-item" href="/#/llm_langchain/57_decision_heatmap.png" target="_blank">
      <img class="llm-dataset-icon" src="https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f4ca.svg" alt="热图"/>
      <div class="llm-dataset-label">决策热图</div>
    </a>
    <a class="llm-dataset-item" href="/#/llm_langchain/58_radar_企业智能问答系统.png" target="_blank">
      <img class="llm-dataset-icon" src="https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f4ca.svg" alt="雷达图"/>
      <div class="llm-dataset-label">企业智能问答系统雷达图</div>
    </a>
    <a class="llm-dataset-item" href="/#/llm_langchain/59_decision_results.json" target="_blank">
      <img class="llm-dataset-icon" src="https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f4ca.svg" alt="结果"/>
      <div class="llm-dataset-label">决策结果数据</div>
    </a>
    <a class="llm-dataset-item" href="/#/llm_langchain/60_langchain_document_loaders_comprehensive_guide.md" target="_blank">
      <img class="llm-dataset-icon" src="https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f4da.svg" alt="指南"/>
      <div class="llm-dataset-label">LangChain文档加载器综合指南</div>
    </a>
    <a class="llm-dataset-item" href="/#/llm_langchain/61_langchain_document_transformers_comprehensive_guide.md" target="_blank">
      <img class="llm-dataset-icon" src="https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f4da.svg" alt="指南"/>
      <div class="llm-dataset-label">LangChain文档转换器综合指南</div>
    </a>
    <a class="llm-dataset-item" href="/#/llm_langchain/62_langchain_document_transformers_advanced_analysis.md" target="_blank">
      <img class="llm-dataset-icon" src="https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f4ca.svg" alt="分析"/>
      <div class="llm-dataset-label">文档转换器高级分析</div>
    </a>
    <a class="llm-dataset-item" href="/#/llm_langchain/63_langchain_doctran_transformers_comprehensive_guide.md" target="_blank">
      <img class="llm-dataset-icon" src="https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f4da.svg" alt="指南"/>
      <div class="llm-dataset-label">LangChain Doctran转换器综合指南</div>
    </a>
    <a class="llm-dataset-item" href="/#/llm_langchain/64_document_transformers_implementation.py" target="_blank">
      <img class="llm-dataset-icon" src="https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f4bb.svg" alt="实现"/>
      <div class="llm-dataset-label">文档转换器实现</div>
    </a>
    <a class="llm-dataset-item" href="/#/llm_langchain/65_document_transformer_benchmark.json" target="_blank">
      <img class="llm-dataset-icon" src="https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f4ca.svg" alt="基准"/>
      <div class="llm-dataset-label">文档转换器基准测试</div>
    </a>
    <a class="llm-dataset-item" href="/#/llm_langchain/66_doctran_implementation.py" target="_blank">
      <img class="llm-dataset-icon" src="https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f4bb.svg" alt="实现"/>
      <div class="llm-dataset-label">Doctran实现</div>
    </a>
    <a class="llm-dataset-item" href="/#/llm_langchain/67_doctran_demo_results.json" target="_blank">
      <img class="llm-dataset-icon" src="https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f4ca.svg" alt="结果"/>
      <div class="llm-dataset-label">Doctran演示结果</div>
    </a>
    <a class="llm-dataset-item" href="/#/llm_langchain/68_doctran_summary.md" target="_blank">
      <img class="llm-dataset-icon" src="https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f4ca.svg" alt="总结"/>
      <div class="llm-dataset-label">Doctran总结</div>
    </a>
    <a class="llm-dataset-item" href="/#/llm_langchain/69_rag_retrievers_implementation.py" target="_blank">
      <img class="llm-dataset-icon" src="https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f4bb.svg" alt="实现"/>
      <div class="llm-dataset-label">RAG检索器实现</div>
    </a>
    <a class="llm-dataset-item" href="/#/llm_langchain/70_rag_retrievers_demo_results.json" target="_blank">
      <img class="llm-dataset-icon" src="https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f4ca.svg" alt="结果"/>
      <div class="llm-dataset-label">RAG检索器演示结果</div>
    </a>
    <a class="llm-dataset-item" href="/#/llm_langchain/71_rag_retrievers_summary.md" target="_blank">
      <img class="llm-dataset-icon" src="https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f4ca.svg" alt="总结"/>
      <div class="llm-dataset-label">RAG检索器总结</div>
    </a>
    <a class="llm-dataset-item" href="/#/llm_langchain/72_langchain_rag_retrievers_comprehensive_manual.md" target="_blank">
      <img class="llm-dataset-icon" src="https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f4da.svg" alt="手册"/>
      <div class="llm-dataset-label">LangChain RAG检索器综合手册</div>
    </a>
    <a class="llm-dataset-item" href="/#/llm_langchain/73_rag_retrievers_professional_analysis.md" target="_blank">
      <img class="llm-dataset-icon" src="https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f4ca.svg" alt="分析"/>
      <div class="llm-dataset-label">RAG检索器专业分析</div>
    </a>
    <a class="llm-dataset-item" href="/#/llm_langchain/74_test_ollama_setup.py" target="_blank">
      <img class="llm-dataset-icon" src="https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f9ea.svg" alt="测试"/>
      <div class="llm-dataset-label">Ollama设置测试</div>
    </a>
    <a class="llm-dataset-item" href="/#/llm_langchain/75_simple_test.py" target="_blank">
      <img class="llm-dataset-icon" src="https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f9ea.svg" alt="测试"/>
      <div class="llm-dataset-label">简单测试</div>
    </a>
    <a class="llm-dataset-item" href="/#/llm_langchain/76_sequential_chain_test.py" target="_blank">
      <img class="llm-dataset-icon" src="https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f9ea.svg" alt="测试"/>
      <div class="llm-dataset-label">序列链测试</div>
    </a>
    <a class="llm-dataset-item" href="/#/llm_langchain/77_requirements.txt" target="_blank">
      <img class="llm-dataset-icon" src="https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f527.svg" alt="依赖"/>
      <div class="llm-dataset-label">依赖要求</div>
    </a>
    <a class="llm-dataset-item" href="/#/llm_langchain/78_upgrade_guide.md" target="_blank">
      <img class="llm-dataset-icon" src="https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f504.svg" alt="升级"/>
      <div class="llm-dataset-label">升级指南</div>
    </a>
    <a class="llm-dataset-item" href="/#/llm_langchain/79_chain.md" target="_blank">
      <img class="llm-dataset-icon" src="https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f4da.svg" alt="文档"/>
      <div class="llm-dataset-label">链技术文档</div>
    </a>
    <a class="llm-dataset-item" href="/#/llm_langchain/80_chain_examples.py" target="_blank">
      <img class="llm-dataset-icon" src="https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f4bb.svg" alt="示例"/>
      <div class="llm-dataset-label">链示例代码</div>
    </a>
    <a class="llm-dataset-item" href="/#/llm_langchain/81_api_requests_demo.py" target="_blank">
      <img class="llm-dataset-icon" src="https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f4bb.svg" alt="演示"/>
      <div class="llm-dataset-label">API请求演示</div>
    </a>
    <a class="llm-dataset-item" href="/#/llm_langchain/82_api_requests_ollama.py" target="_blank">
      <img class="llm-dataset-icon" src="https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f4bb.svg" alt="Ollama"/>
      <div class="llm-dataset-label">Ollama API请求</div>
    </a>
    <a class="llm-dataset-item" href="/#/llm_langchain/83_api_chain_summary.md" target="_blank">
      <img class="llm-dataset-icon" src="https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f4da.svg" alt="总结"/>
      <div class="llm-dataset-label">API链总结</div>
    </a>
    <a class="llm-dataset-item" href="/#/llm_langchain/84_conversational_qa_service.py" target="_blank">
      <img class="llm-dataset-icon" src="https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f4bb.svg" alt="服务"/>
      <div class="llm-dataset-label">对话式问答服务</div>
    </a>
    <a class="llm-dataset-item" href="/#/llm_langchain/85_qa_client_demo.py" target="_blank">
      <img class="llm-dataset-icon" src="https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f4bb.svg" alt="客户端"/>
      <div class="llm-dataset-label">问答客户端演示</div>
    </a>
    <a class="llm-dataset-item" href="/#/llm_langchain/86_conversational_summary.md" target="_blank">
      <img class="llm-dataset-icon" src="https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f4da.svg" alt="总结"/>
      <div class="llm-dataset-label">对话系统总结</div>
    </a>
    <a class="llm-dataset-item" href="/#/llm_langchain/87_memory_app.md" target="_blank">
      <img class="llm-dataset-icon" src="https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f4da.svg" alt="文档"/>
      <div class="llm-dataset-label">记忆应用文档</div>
    </a>
    <a class="llm-dataset-item" href="/#/llm_langchain/88_llm_evaluator.md" target="_blank">
      <img class="llm-dataset-icon" src="https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f4ca.svg" alt="评估"/>
      <div class="llm-dataset-label">LLM评估系统</div>
    </a>
  </div>
</div>

<div class="llm-dataset-section main-content">
  <div class="llm-dataset-title">LLM-Agents-Adala</div>
  <div class="llm-dataset-wall">
    <a class="llm-dataset-item" href="/#/llm_agents/adala/agent_architecture.md" target="_blank">
      <img class="llm-dataset-icon" src="https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f4c8.svg" alt="数据集格式"/>
      <div class="llm-dataset-label">智能标注架构</div>
    </a>
    <a class="llm-dataset-item" href="/#/llm_agents/adala/agent_cheatsheet.md" target="_blank">
      <img class="llm-dataset-icon" src="https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f4c8.svg" alt="数据集格式"/>
      <div class="llm-dataset-label">智能标注速查</div>
    </a>
    <a class="llm-dataset-item" href="/#/llm_agents/adala/agent_technical_analysis.md" target="_blank">
      <img class="llm-dataset-icon" src="https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f4c8.svg" alt="数据集格式"/>
      <div class="llm-dataset-label">智能标注技术分析</div>
    </a>
    <a class="llm-dataset-item" href="/#/llm_agents/adala/agent_visualization.md" target="_blank">
      <img class="llm-dataset-icon" src="https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f4c8.svg" alt="数据集格式"/>
      <div class="llm-dataset-label">智能标注可视化</div>
    </a>
    <a class="llm-dataset-item" href="/#/llm_agents/adala/classification_skill_analysis.md" target="_blank">
      <img class="llm-dataset-icon" src="https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f4c8.svg" alt="数据集格式"/>
      <div class="llm-dataset-label">分类技能分析</div>
    </a>
    <a class="llm-dataset-item" href="/#/llm_agents/adala/classification_skill_cheatsheet.md" target="_blank">
      <img class="llm-dataset-icon" src="https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f4c8.svg" alt="数据集格式"/>
      <div class="llm-dataset-label">分类技能速查</div>
    </a>
    <a class="llm-dataset-item" href="/#/llm_agents/adala/classification_skill_llm_analysis_flow.md" target="_blank">
      <img class="llm-dataset-icon" src="https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f4c8.svg" alt="数据集格式"/>
      <div class="llm-dataset-label">分类技能LLM分析流程</div>
    </a>
    <a class="llm-dataset-item" href="/#/llm_agents/adala/classification_skill_visualization.md" target="_blank">
      <img class="llm-dataset-icon" src="https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f4c8.svg" alt="数据集格式"/>
      <div class="llm-dataset-label">分类技能可视化</div>
    </a>
    <a class="llm-dataset-item" href="/#/llm_agents/adala/classification_skill_visualization.html" target="_blank">
      <img class="llm-dataset-icon" src="https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f4c8.svg" alt="数据集格式"/>
      <div class="llm-dataset-label">分类技能可视化</div>
    </a>
    <!-- 插入一个gif 图片 -->
    <!-- <a class="llm-dataset-item" href="/#/llm_agents/adala/recadala_speed_5.gif" target="_blank"> -->
  </div>
</div>

<!-- LLM-Agents-Adala 优化样式 -->
<style>
.adala-gallery-section {
  margin: 40px 0;
...
<div class="adala-gallery-section">
  <div class="adala-gallery-title">LLM-Agents-Adala</div>
  <div class="adala-gallery-container">
    <div class="adala-gallery-item">
      <div class="adala-gallery-gif-container">
        <img class="adala-gallery-gif" src="/llm_agents/adala/recadala_speed_5.gif" alt="分类技能可视化"/>
      </div>
      <div class="adala-gallery-label">分类技能可视化</div>
    </div>
  </div>
</div>

<div class="llm-dataset-section main-content">
  <div class="llm-dataset-title">LLM-Agents-DataCreator-QA</div>
  <div class="llm-dataset-wall">
    <a class="llm-dataset-item" href="/#/llm_agents/datacreator/README.md" target="_blank">
      <img class="llm-dataset-icon" src="https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f4c8.svg" alt="数据集格式"/>
      <div class="llm-dataset-label">智能QA数据生成</div>
    </a>
  </div>
</div>

<div class="adala-gallery-section">
  <div class="adala-gallery-title">LLM-Agents-DataCreator-QA</div>
  <div class="adala-gallery-container">
    <div class="adala-gallery-item">
      <div class="adala-gallery-gif-container">
        <img class="adala-gallery-gif" src="/llm_agents/datacreator/rec_speed_5.gif" alt="智能数据生成"/>
      </div>
      <div class="adala-gallery-label">智能QA数据生成</div>
    </div>
  </div>
</div>

<div class="llm-dataset-section main-content">
  <div class="llm-dataset-title">LLM-Agents-DataCreator-结构化数据</div>
  <div class="llm-dataset-wall">
    <a class="llm-dataset-item" href="/#/llm_agents/datacreator/2/README.md" target="_blank">
      <img class="llm-dataset-icon" src="https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f4c8.svg" alt="数据集格式"/>
      <div class="llm-dataset-label">智能结构化数据生成</div>
    </a>
    <a class="llm-dataset-item" href="/#/llm_agents/datacreator/2/README_museum_finetune.md" target="_blank">
      <img class="llm-dataset-icon" src="https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f4c8.svg" alt="数据集格式"/>
      <div class="llm-dataset-label">智能结构化数据生成（博物馆）</div>
    </a>
    <a class="llm-dataset-item" href="/#/llm_agents/datacreator/2/README_museum_impl.md" target="_blank">
      <img class="llm-dataset-icon" src="https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f4c8.svg" alt="数据集格式"/>
      <div class="llm-dataset-label">智能结构化数据生成（博物馆-plus）</div>
    </a>
    <a class="llm-dataset-item" href="/#/llm_agents/datacreator/2/README_movie.md" target="_blank">
      <img class="llm-dataset-icon" src="https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f4c8.svg" alt="数据集格式"/>
      <div class="llm-dataset-label">智能结构化数据生成（电影）</div>
    </a>
  </div>
</div>

<div class="llm-dataset-section main-content">
  <div class="llm-dataset-title">LLM-Agents-基于Baichuan2-7B的角色扮演模型微调</div>
  <div class="llm-dataset-wall">
    <a class="llm-dataset-item" href="/#/llm_agents/datacreator/2/README.md" target="_blank">
      <img class="llm-dataset-icon" src="https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f4c8.svg" alt="数据集格式"/>
      <div class="llm-dataset-label">基于Baichuan2-7B的角色扮演模型微调</div>
    </a>
  </div>
</div>

<div class="adala-gallery-section">
  <div class="adala-gallery-title">LLM-Agents-基于Qwen2-8B模型应用</div>
  <div class="adala-gallery-container">
    <div class="adala-gallery-item">
      <div class="adala-gallery-gif-container">
        <img class="adala-gallery-gif" src="/llm_agents/qwen_media_qa_training_dialog/rec_speed_5.gif" alt="智能数据生成"/>
      </div>
      <div class="adala-gallery-label">基于Qwen2-8B模型微调（对话形态的医疗QA、药物信息抽取）</div>
    </div>
  </div>
</div>

<div class="llm-dataset-section main-content">
  <div class="llm-dataset-title">LLM-Agents-基于Qwen2-8B模型应用</div>
  <div class="llm-dataset-wall">
    <a class="llm-dataset-item" href="/#/llm_agents/qwen_media_qa_training_dialog/README.md" target="_blank">
      <img class="llm-dataset-icon" src="https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f4c8.svg" alt="数据集格式"/>
      <div class="llm-dataset-label">基于Qwen2-8B模型微调（对话形态的医疗QA、药物信息抽取）</div>
    </a>
  </div>
</div>
...
<div class="adala-gallery-section">
  <div class="adala-gallery-title">LLM-Agents-构建自己专属GPT2</div>
  <div class="adala-gallery-container">
    <div class="adala-gallery-item">
      <div class="adala-gallery-gif-container">
        <img class="adala-gallery-gif" src="/llm_agents/privategpt2/rec_speed_50.gif" alt="智能数据生成"/>
      </div>
      <div class="adala-gallery-label">专属GPT2（文本生成）</div>
    </div>
    <div class="adala-gallery-item">
      <div class="adala-gallery-gif-container">
        <img class="adala-gallery-gif" src="/llm_agents/privategpt2/rec_speed_5.gif" alt="智能数据生成"/>
      </div>
      <div class="adala-gallery-label">专属GPT2（文本生成）</div>
    </div>
  </div>
...
<div class="llm-dataset-section main-content">
  <div class="llm-dataset-title">LLM-Agents-DeepseekCoder</div>
  <div class="llm-dataset-wall">
    <a class="llm-dataset-item" href="/#/llm_agents/text2sql/README.md" target="_blank">
      <img class="llm-dataset-icon" src="https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f4c8.svg" alt="数据集格式"/>
      <div class="llm-dataset-label">训练自己的Coder（文本转SQL）</div>
    </a>
  </div>
</div>

<div class="adala-gallery-section">
  <div class="adala-gallery-title">LLM-Agents-DeepseekCoder</div>
  <div class="adala-gallery-container">
    <div class="adala-gallery-item">
      <div class="adala-gallery-gif-container">
        <img class="adala-gallery-gif" src="/llm_agents/text2sql/rec_speed_5.gif" alt="智能数据生成"/>
      </div>
      <div class="adala-gallery-label">训练自己的Coder（文本转SQL）</div>
    </div>
    <div class="adala-gallery-item">
      <div class="adala-gallery-gif-container">
        <img class="adala-gallery-gif" src="/llm_agents/text2sql/rec_call_deepseek_coder.gif" alt="智能数据生成"/>
      </div>
      <div class="adala-gallery-label">训练自己的Coder（文本转SQL）</div>
    </div>
  </div>
...
<div class="llm-dataset-section main-content">
  <div class="llm-dataset-title">LLM-基于BGE的训练</div>
  <div class="llm-dataset-wall">
    <a class="llm-dataset-item" href="/#/llm/finetuning/bge-finetune/README.md" target="_blank">
      <img class="llm-dataset-icon" src="https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f4c8.svg" alt="数据集格式"/>
      <div class="llm-dataset-label">基于BGE的训练（超大规模的医疗数据的QA）</div>
    </a>
  </div>
</div>

<div class="llm-dataset-section main-content">
  <div class="llm-dataset-title">LLM-基于智谱ChatGLM3的训练</div>
  <div class="llm-dataset-wall">
    <a class="llm-dataset-item" href="/#/llm/finetuning/chatglm3-finetune/README.md" target="_blank">
      <img class="llm-dataset-icon" src="https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f4c8.svg" alt="数据集格式"/>
      <div class="llm-dataset-label">基于智谱ChatGLM3的训练</div>
    </a>
  </div>
</div>
...
.adala-gallery-video::-webkit-media-controls {
  border-radius: 12px;
}
...
<div class="adala-gallery-section">
  <div class="adala-gallery-title">LLM-基于Streamlit + BGE-M3 + ChatGLM3 + FAISS的本地知识库</div>
  <div class="adala-gallery-container">
    <div class="adala-gallery-item">
      <div class="adala-gallery-gif-container">
        <img class="adala-gallery-gif" src="/llm/finetuning/bge-chatglm3-rag-knowlege/rec_speed_5.gif" alt="基于Streamlit + BGE-M3 + ChatGLM3 + FAISS的本地知识库"/>
      </div>
      <div class="adala-gallery-label">基于Streamlit + BGE-M3 + ChatGLM3 + FAISS的本地知识库</div>
    </div>
    <div class="adala-gallery-item">
      <div class="adala-gallery-gif-container">
        <video class="adala-gallery-video" controls preload="metadata" src="/llm/finetuning/bge-chatglm3-rag-knowlege/RAG-问答系统-TianLongBaBu.mp4" alt="基于Streamlit + BGE-M3 + ChatGLM3 + FAISS的Local Knowledge Base">
          您的浏览器不支持视频播放，请 <a href="/llm/finetuning/bge-chatglm3-rag-knowlege/RAG-问答系统-TianLongBaBu.mp4" target="_blank">点击这里</a> 下载观看
        </video>
      </div>
      <div class="adala-gallery-label">基于Streamlit + BGE-M3 + ChatGLM3 + FAISS的本地知识库</div>
    </div>
...
<div class="llm-dataset-section main-content">
  <div class="llm-dataset-title">BabyAGI（智能体对话）</div>
  <div class="llm-dataset-wall">
    <a class="llm-dataset-item" href="/#/llm_agents/babyagi/README.md" target="_blank">
      <img class="llm-dataset-icon" src="https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f4c8.svg" alt="数据集格式"/>
      <div class="llm-dataset-label">BabyAGI（智能体对话）</div>
    </a>
  </div>
</div>

<div class="adala-gallery-section">
  <div class="adala-gallery-title">LLM-BabyAGI（智能体对话）</div>
  <div class="adala-gallery-container">
    <div class="adala-gallery-item">
      <div class="adala-gallery-gif-container">
        <img class="adala-gallery-gif" src="/llm_agents/babyagi/rec_speed_5.gif" alt="基于Streamlit"/>
      </div>
      <div class="adala-gallery-label">BabyAGI（智能体对话）</div>
    </div>
    <div class="adala-gallery-item">
      <div class="adala-gallery-gif-container">
        <video class="adala-gallery-video" controls preload="metadata" src="/llm_agents/babyagi/BabyAGI-Function-Dashboard.mp4" alt="BabyAGI-Function-Dashboard.mp4" type="video/mp4">
          您的浏览器不支持视频播放，请 <a href="/llm_agents/babyagi/BabyAGI-Function-Dashboard.mp4" target="_blank">点击这里</a> 下载观看
        </video>
      </div>
      <div class="adala-gallery-label">BabyAGI（智能体对话）</div>
    </div>
...
<div class="llm-dataset-section main-content">
  <div class="llm-dataset-title">手搓一个能自主扩展需求的智能体</div>
  <div class="llm-dataset-wall">
    <a class="llm-dataset-item" href="/#/llm_agents/buildbyselfagent/README.md" target="_blank">
      <img class="llm-dataset-icon" src="https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f4c8.svg" alt="数据集格式"/>
      <div class="llm-dataset-label">手搓一个能自主扩展需求的智能体</div>
    </a>
  </div>
</div>

<div class="adala-gallery-section">
  <div class="adala-gallery-title">多智能体Agent-管理系统</div>
  <div class="adala-gallery-container">
    <div class="adala-gallery-item">
      <div class="adala-gallery-gif-container">
        <img class="adala-gallery-gif" src="/llm_agents/buildbyselfagent/rec_speed_5.gif" alt="基于Streamlit"/>
      </div>
      <div class="adala-gallery-label">BabyAGI-Agent-管理系统</div>
    </div>
    <div class="adala-gallery-item">
      <div class="adala-gallery-gif-container">
        <video class="adala-gallery-video" controls preload="metadata" src="/llm_agents/buildbyselfagent/BabyAGI-Agent-管理系统.mp4" alt="BabyAGI-Agent-管理系统.mp4" type="video/mp4">
          您的浏览器不支持视频播放，请 <a href="/llm_agents/buildbyselfagent/BabyAGI-Agent-管理系统.mp4" target="_blank">点击这里</a> 下载观看
        </video>
      </div>
      <div class="adala-gallery-label">BabyAGI-Agent-管理系统</div>
    </div>
...
<div class="adala-gallery-section">
  <div class="adala-gallery-title">多智能体协同</div>
  <div class="adala-gallery-container">
    <div class="adala-gallery-item">
      <div class="adala-gallery-gif-container">
        <img class="adala-gallery-gif" src="/llm_agents/camel/rec_it_manager.gif" alt="基于Streamlit"/>
      </div>
      <div class="adala-gallery-label">交互式产品经理智能体</div>
    </div>
    <div class="adala-gallery-item">
      <div class="adala-gallery-gif-container">
        <img class="adala-gallery-gif" src="/llm_agents/camel/rec_roleplay_speed_5.gif" alt="基于Streamlit"/>
      </div>
      <div class="adala-gallery-label">全领域知识问答智能体（出题+答题）</div>
    </div>
    <div class="adala-gallery-item">
      <div class="adala-gallery-gif-container">
        <img class="adala-gallery-gif" src="/llm_agents/camel/rec_speed_5.gif" alt="基于Streamlit"/>
      </div>
      <div class="adala-gallery-label">旅行规划师</div>
    </div>
    <div class="adala-gallery-item">
      <div class="adala-gallery-gif-container">
        <img class="adala-gallery-gif" src="/llm_agents/camel/teacher_prepare_worker.gif" alt="基于Streamlit"/>
      </div>
      <div class="adala-gallery-label">教师主题备课Agent</div>
    </div>
  </div>
</div>

<div class="llm-dataset-section main-content">
  <div class="llm-dataset-title">全领域知识问答智能体（出题+答题）系统设计</div>
  <div class="llm-dataset-wall">
    <a class="llm-dataset-item" href="/#/llm_agents/camel/universal_roleplay_guide.md" target="_blank">
      <img class="llm-dataset-icon" src="https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f4c8.svg" alt="全领域知识问答智能体（出题+答题）系统设"/>
      <div class="llm-dataset-label">全领域知识问答智能体（出题+答题）系统设计</div>
    </a>
  </div>
  <div class="llm-dataset-wall">
    <a class="llm-dataset-item" href="/#/llm_agents/camel/role_playing_with_human_q_writer_teacher.md" target="_blank">
      <img class="llm-dataset-icon" src="https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f4c8.svg" alt="全领域知识问答智能体（出题+答题）系统设"/>
      <div class="llm-dataset-label">教师主题备课Agent产出预览</div>
    </a>
  </div>
</div>

<div class="llm-dataset-section main-content">
  <div class="llm-dataset-title">教学场景智能体系统设计</div>
  <div class="llm-dataset-wall">
    <a class="llm-dataset-item" href="/#/llm_agents/camel/teacher_student_learning.md" target="_blank">
      <img class="llm-dataset-icon" src="https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f4c8.svg" alt="教学场景智能体系统设计"/>
      <div class="llm-dataset-label">教学场景智能体系统设计</div>
    </a>
  </div>
</div>

<div class="adala-gallery-section">
  <div class="adala-gallery-title">多角色Agent交互</div>
  <div class="adala-gallery-container">
    <div class="adala-gallery-item">
      <div class="adala-gallery-gif-container">
        <img class="adala-gallery-gif" src="/llm_agents/camel/teacher_student_learning.gif" alt="基于Streamlit"/>
      </div>
      <div class="adala-gallery-label">教师学生学习智能体</div>
    </div>
  </div>
</div>
<div class="llm-dataset-section main-content">
  <div class="llm-dataset-title">教师学生学习智能体系统设计</div>
  <div class="llm-dataset-wall">
    <a class="llm-dataset-item" href="/#/llm_agents/camel/teacher_student_learning.md" target="_blank">
      <img class="llm-dataset-icon" src="https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f4c8.svg" alt="教师学生学习智能体系统设计"/>
      <div class="llm-dataset-label">教师学生学习智能体系统设计</div>
    </a>
  </div>
</div>
...
<div class="adala-gallery-section">
  ...
  <div class="adala-gallery-container">
    <div class="adala-gallery-item">
      <div class="adala-gallery-gif-container">
        <img class="adala-gallery-gif" src="/llm_agents/camel/school_system.gif" alt="基于Streamlit"/>
      </div>
      <div class="adala-gallery-label">学校智能化Agent</div>
    </div>
    <div class="adala-gallery-item">
      <div class="adala-gallery-gif-container">
        <img class="adala-gallery-gif" src="/llm_agents/camel/teacher_student_scenario.gif" alt="基于Streamlit"/>
      </div>
      <div class="adala-gallery-label">教学场景智能体系统设计</div>
    </div>
    <div class="adala-gallery-item">
      <div class="adala-gallery-gif-container">
        <img class="adala-gallery-gif" src="/llm_agents/camel/expense_reimbursement.gif" alt="基于Streamlit"/>
      </div>
      <div class="adala-gallery-label">报销智能体</div>
    </div>
  </div>
</div>
<div class="llm-dataset-section main-content">
  <div class="llm-dataset-title">多角色Agent交互</div>
  <div class="llm-dataset-wall">
    <a class="llm-dataset-item" href="/#/llm_agents/camel/camel_school_system_technical_documentation.md" target="_blank">
      <img class="llm-dataset-icon" src="https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f4c8.svg" alt="学校智能化Agent"/>
      <div class="llm-dataset-label">学校智能化Agent</div>
    </a>
  </div>
  <div class="llm-dataset-wall">
    <a class="llm-dataset-item" href="/#/llm_agents/camel/teacher_student_scenario_runner_technical_documentation.md" target="_blank">
      <img class="llm-dataset-icon" src="https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f4c8.svg" alt="教学场景智能体系统设计"/>
      <div class="llm-dataset-label">教学场景智能体系统设计</div>
    </a>
  </div>
  <div class="llm-dataset-wall">
    <a class="llm-dataset-item" href="/#/llm_agents/camel/camel_expense_reimbursement_technical_documentation.md" target="_blank">
      <img class="llm-dataset-icon" src="https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f4c8.svg" alt="报销智能体"/>
      <div class="llm-dataset-label">报销智能体</div>
    </a>
  </div>
</div>
...
<div class="adala-gallery-section">
  ...
  <div class="adala-gallery-container">
    <div class="adala-gallery-item">
      <div class="adala-gallery-gif-container">
        <img class="adala-gallery-gif" src="/llm_agents/agentscope/museum/rec.gif" alt="基于Streamlit"/>
      </div>
      <div class="adala-gallery-label">博物馆智能问答系统</div>
    </div>
    <div class="adala-gallery-item">
      <div class="adala-gallery-gif-container">
        <video class="adala-gallery-video" controls preload="metadata" src="/llm_agents/agentscope/museum/博物馆智能问答系统.mp4" alt="博物馆智能问答系统.mp4" type="video/mp4">
          您的浏览器不支持视频播放，请 <a href="/llm_agents/agentscope/museum/博物馆智能问答系统.mp4" target="_blank">点击这里</a> 下载观看
        </video>
      </div>
      <div class="adala-gallery-label">博物馆智能问答系统</div>
    </div>
...
<div class="llm-dataset-section main-content">
  <div class="llm-dataset-title">博物馆多智能体建设</div>
  <div class="llm-dataset-wall">
    <a class="llm-dataset-item" href="/#/llm_agents/agentscope/museum/README.md" target="_blank">
      <img class="llm-dataset-icon" src="https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f4c8.svg" alt="学校智能化Agent"/>
      <div class="llm-dataset-label">博物馆多智能体建设技术方案</div>
    </a>
  </div>
</div>

<div class="adala-gallery-section">
  <div class="adala-gallery-title">企业智能化-HR政策 </div>
  <div class="adala-gallery-container">
    <div class="adala-gallery-item">
      <div class="adala-gallery-gif-container">
        <img class="adala-gallery-gif" src="/llm_agents/lang_chain_graph/rec.gif" alt="基于Streamlit"/>
      </div>
      <div class="adala-gallery-label">企业智能化-HR-咨询</div>
    </div>
    <div class="adala-gallery-item">
      <div class="adala-gallery-gif-container">
        <video class="adala-gallery-video" controls preload="metadata" src="/llm_agents/lang_chain_graph/HR-聊天机器人-LangChain版-.mp4" alt="企业智能化-HR-咨询.mp4" type="video/mp4">
          您的浏览器不支持视频播放，请 <a href="/llm_agents/lang_chain_graph/HR-聊天机器人-LangChain版-.mp4" target="_blank">点击这里</a> 下载观看
        </video>
      </div>
      <div class="adala-gallery-label">博物馆智能问答系统LangChain</div>
    </div>
    <div class="adala-gallery-item">
      <div class="adala-gallery-gif-container">
        <video class="adala-gallery-video" controls preload="metadata" src="/llm_agents/lang_chain_graph/HR-聊天机器人-LangGraph版-.mp4" alt="企业智能化-HR-咨询.mp4" type="video/mp4">
          您的浏览器不支持视频播放，请 <a href="/llm_agents/lang_chain_graph/HR-聊天机器人-LangGraph版-.mp4" target="_blank">点击这里</a> 下载观看
        </video>
      </div>
      <div class="adala-gallery-label">博物馆智能问答系统LangGraph</div>
    </div>
    <div class="adala-gallery-item">
      <div class="adala-gallery-gif-container">
        <video class="adala-gallery-video" controls preload="metadata" src="/llm_agents/lang_chain_graph/Traceloop.mp4" alt="Traceloop.mp4" type="video/mp4">
          您的浏览器不支持视频播放，请 <a href="/llm_agents/lang_chain_graph/Traceloop.mp4" target="_blank">点击这里</a> 下载观看
        </video>
      </div>
      <div class="adala-gallery-label">博物馆智能问答系统链路跟踪</div>
    </div>
  </div>
</div>

<div class="llm-dataset-section main-content">
  <div class="llm-dataset-title">企业智能化-HR政策Agent</div>
  <div class="llm-dataset-wall">
    <a class="llm-dataset-item" href="/#/llm_agents/lang_chain_graph/README_T.md" target="_blank">
      <img class="llm-dataset-icon" src="https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f4c8.svg" alt="学校智能化Agent"/>
      <div class="llm-dataset-label">企业智能化-HR-咨询</div>
    </a>
  </div>
</div>

<div class="llm-dataset-section main-content">
  <div class="llm-dataset-title">识别图像内容并解析内容</div>
  <div class="llm-dataset-wall">
    <a class="llm-dataset-item" href="/#/llm_image_to_text/README.md" target="_blank">
      <img class="llm-dataset-icon" src="https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f4c8.svg" alt="学校智能化Agent"/>
      <div class="llm-dataset-label">识别图像内容并解析内容</div>
    </a>
  </div>
</div>

<div class="llm-dataset-section main-content">
  <div class="llm-dataset-title">数学解题智能体</div>
  <div class="llm-dataset-wall">
    <a class="llm-dataset-item" href="/#/math_agent/README.md" target="_blank">
      <img class="llm-dataset-icon" src="https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f4c8.svg" alt="数学解题智能体"/>
      <div class="llm-dataset-label">数学解题智能体</div>
    </a>
  </div>
</div>

<div class="adala-gallery-section">
  <div class="adala-gallery-title">数学解题智能体</div>
  <div class="adala-gallery-container">
    <div class="adala-gallery-item">
      <div class="adala-gallery-gif-container">
        <video class="adala-gallery-video" controls preload="metadata" src="/llm_agents/math_agent/数学解题-Agent.mp4" alt="数学解题-Agent.mp4" type="video/mp4">
          您的浏览器不支持视频播放，请 <a href="/llm_agents/lang_chain_graph/数学解题-Agent.mp4" target="_blank">点击这里</a> 下载观看
        </video>
      </div>
      <div class="adala-gallery-label">博物馆智能问答系统链路跟踪</div>
    </div>
