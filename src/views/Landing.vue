...
import { getTrendingTracks } from '../api/music'
        ...
        <div class="multi-ad-container">
          <div class="ad-scroll-area">
            <div class="ad-scroll-content">
              <div class="ad-row">
                <a href="https://example.com/ad1" target="_blank">
                  <img :src="'/static/advertisment/adb-1.webp'" alt="广告1" />
                </a>
                <a href="https://example.com/ad2" target="_blank">
                  <img :src="'/static/advertisment/adb-1.webp'" alt="广告2" />
                </a>
                <a href="https://example.com/ad3" target="_blank">
                  <img :src="'/static/advertisment/adb-1.webp'" alt="广告3" />
                </a>
                <a href="https://example.com/ad1" target="_blank">
                  <img :src="'/static/advertisment/adb-1.webp'" alt="广告1" />
                </a>
              ...
              <div class="ad-row reverse">
                ...
                <a href="https://example.com/ad2" target="_blank">
                  <img :src="'/static/advertisment/adb-2.webp'" alt="广告2" />
                </a>
                <a href="https://example.com/ad3" target="_blank">
                  <img :src="'/static/advertisment/adb-3.webp'" alt="广告3" />
                </a>
                <a href="https://example.com/ad1" target="_blank">
                  <img :src="'/static/advertisment/adb-1.webp'" alt="广告1" />
                </a>
