    ...
    <div class="main-content">
      <section class="trending-section">
        ...
        <div class="track-list">
          <Card v-for="track in musicList" :key="track.id" class="track-list-item" hoverable>
...
.track-content:hover .play-overlay,
