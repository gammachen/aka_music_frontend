...
import { getTrendingTracks, getAllComicGenre } from '../../api/comic'
...
import ImagePKCard from '../../components/ImagePKCard.vue'
import ImagePKCard2 from '../../components/ImagePKCard2.vue'
import ImagePKCard3 from '../../components/ImagePKCard3.vue'
import Image3DCard from '../../components/Image3DCard.vue'

const router = useRouter()
const allComicGeneres = ref([
    {
      "category": "冒险漫画",
      "comics": [
        {
...
onMounted(async () => {
  try {
    const response = await getAllComicGenre()
    console.log('获取所有内容列表:', response)

    if (response && response.data && response.data.length > 0) {
      allComicGeneres.value = response.data
...
const getRandomDefaultCover = () => {
  ...
  return `/img/def/a${randomNum}.png`
}

const getDefaultVideoUrl = () => {
  // const randomNum = Math.floor(Math.random() * 8) + 1
  return `/static/def/video_2.mp4`
}
...
<template>
  <Layout class="landing-layout">
    ...
    <div class="main-content">
      <section v-for="genre in allComicGeneres" :key="genre.category" class="trending-section">
        <h2>{{ genre.category }}</h2>
        <div class="track-grid">
          <Card v-for="comic in genre.comics" :key="comic.name" class="track-card" hoverable>
            <div class="track-cover">
              <img :src="(comic.cover_url && comic.cover_url !== '/static/covers/comic/default_cover.jpg') ? comic.cover_url : getRandomDefaultCover()" :alt="comic.name" />
            </div>
            <div class="track-info" @click="router.push(`/comic/${comic.name}`)">
              <h3>{{ comic.name }}</h3>
              <p>{{ comic.author }} · {{ comic.publish_date }}</p>
          ...
          <div class="ad-slides">
            <div class="ad-slide">
              <a href="https://example.com/ad1" target="_blank">
                <img src="/img/def/ad1.png" alt="广告1" />
              </a>
            </div>
            <div class="ad-slide">
              <a href="https://example.com/ad2" target="_blank">
                <img src="/img/def/ad2.png" alt="广告2" />
              </a>
            </div>
            <div class="ad-slide">
              <a href="https://example.com/ad1" target="_blank">
        ...
        <div class="multi-ad-container">
          <div class="ad-scroll-area">
            <div class="ad-scroll-content">
              ...
              <div class="ad-row reverse">
                <a href="https://example.com/ad1" target="_blank">
                  <img src="/img/def/adb-2.webp" alt="广告1" />
                </a>
                <a href="https://example.com/ad2" target="_blank">
                  <img src="/img/def/adb-2.webp" alt="广告2" />
                </a>
                <a href="https://example.com/ad3" target="_blank">
                  <img src="/img/def/adb-2.webp" alt="广告3" />
                </a>
                <a href="https://example.com/ad1" target="_blank">
                  <img src="/img/def/adb-2.webp" alt="广告1" />
                </a>
              ...
              <div class="ad-row">
                <a href="https://example.com/ad1" target="_blank">
                  <img src="/img/def/adb-3.webp" alt="广告1" />
                </a>
                <a href="https://example.com/ad2" target="_blank">
                  <img src="/img/def/adb-3.webp" alt="广告2" />
                </a>
                <a href="https://example.com/ad3" target="_blank">
                  <img src="/img/def/adb-3.webp" alt="广告3" />
                </a>
                <a href="https://example.com/ad1" target="_blank">
                  <img src="/img/def/adb-3.webp" alt="广告1" />
                </a>
          ...
          <div class="video-player">
            <video ref="videoPlayer" controls>
              <source :src="getDefaultVideoUrl()" type="video/mp4">
              您的浏览器不支持视频播放
            </video>
          </div>
      ...
      <section class="music-effect-section">
        <div class="effect-container">
          ...
          <div class="phone-layer">
            <img src="/img/def/phone.webp" alt="手机设备" />
          </div>
        </div>
      </section>
      ...
      <section class="banner-image">
        <a href="https://example.com/banner" target="_blank">
          <img src="/img/def/adb.png" alt="横幅广告" />
        </a>
      </section>
      ...
      <section class="app-promotion">
        <div class="app-content">
          ...
          <div class="app-qrcode">
            <img src="/img/def/qrcode.png" alt="扫码下载" />
            <p>扫码下载</p>
          </div>
        </div>
      </section>
...
.background-layer {
  ...
  width: 100%;
  height: 100%;
  background: url('/img/def/sky.webp') center/cover  no-repeat;
  opacity: 0.6;
  z-index: 1;
}
